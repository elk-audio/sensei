...
namespace sensei {
		...
		typedef uint8_t VectorDataImu[sizeof(sensei::sImuQuaternion) + sizeof(sensei::sImuLinearAcceleration) +sizeof(sensei::sImuComponentSensor) + sizeof(sensei::sImuNormalizedComponentSensor)];

		typedef union Data
		{
			SystemSettings systemSettings;
			HardwareSettings hw;
			sensei::sImuSettings imuSettings;
